...
CREATE TABLE `user_base` (
  ...
  `first_phone` varchar(13) DEFAULT NULL COMMENT '手机号',
...
insert into user_base(user_name,first_phone,address,create_time) values (IFNULL(NULL,user_name),'120','xxx',now());
insert into user_base(user_name,first_phone,address,create_time) values ('李4','110','xxx额',now());
insert into user_base(user_name,first_phone,address,create_time) values ('张三','911','xxx是啥',now());
